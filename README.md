...
This is a function to copy the node layout of a qgraph (Epskamp et al., 2012) item so that other networks with the same nodes can be easily visually compared in circle layouts.
